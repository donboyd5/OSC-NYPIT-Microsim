...
```{r 2018xsalt_summary, rows.print=20}
...
tab <- pol_change_table(data, tab_title, tab_subtitle, p1name, p2name)
gtsave(tab, "2018xsalt_summary_table.png", path = here::here("results"))
...
for(st in nyus_sort){
  print(st)
  tab <- get_state_tab(st, policy1, policy2, p1name, p2name, dollars)
  gtsave(tab, paste0("2018xSALT_byagi_table_", st, ".png"), path = here::here("results"))
  # print(tab)
}
...
```{r 2018xsalt_pdiff_wide, rows.print=20}
...
gtsave(tab, "2018xsalt_pdiff_byagi_wide_table.png", path = here::here("results"))
tab
