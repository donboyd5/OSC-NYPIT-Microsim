...
```{r iit_summary_allstates, rows.print=20}
...
iit_tab <- pol_change_table(data, tab_title, tab_subtitle, p1name, p2name)
gtsave(iit_tab, "iit_allstates_table.png", path = here::here("results"))

iit_tab

```

```{r iit_one_state_byagi}
...
for(st in nyus_sort){
  ...
  gtsave(tab, paste0("iit_byagi_table_", st, ".png"), path = here::here("results"))
  # print(tab)
}
...
iitwide_tab <- pdiff_wide_table(data, tab_title, tab_subtitle)

gtsave(iitwide_tab, "iitpdiff_byagi_allstates_table.png", path = here::here("results"))
iitwide_tab
...
```{r salt_summary_allstates, rows.print=20}
...
iitxsalt_tab <- pol_change_table(data, tab_title, tab_subtitle, p1name, p2name)
gtsave(iitxsalt_tab, "iitxsalt_table.png", path = here::here("results"))
...
for(st in nyus_sort){
  print(st)
  tab <- get_state_tab(st, policy1, policy2, p1name, p2name, dollars)
  gtsave(tab, paste0("iitxSALT_byagi_table_", st, ".png"), path = here::here("results"))
  # print(tab)
}
...
iitwide_xSALT_tab <- pdiff_wide_table(data, tab_title, tab_subtitle)

gtsave(iitwide_xSALT_tab, "iitxSALT_pdiff_byagi_allstates_table.png", path = here::here("results"))
iitwide_xSALT_tab
...
sd_tab <- pol_change_table(data, tab_title, tab_subtitle, p1name, p2name)
gtsave(sd_tab, "sd_allstates_table.png", path = here::here("results"))

sd_tab
```


```{r sd_one_state_byagi}
...
for(st in nyus_sort){
  print(st)
  tab <- get_state_tab(st, policy1, policy2, p1name, p2name, dollars)
  gtsave(tab, paste0("sd_byagi_table_", st, ".png"), path = here::here("results"))
  # print(tab)
}
...
wide_sd_tab <- pdiff_wide_table(data, tab_title, tab_subtitle)

gtsave(wide_sd_tab, "wide_sd_pdiff_byagi_allstates_table.png", path = here::here("results"))
wide_sd_tab

```

## Impact of standard deduction combined
...
```{r sdsalt_summary_allstates, rows.print=20}
...
tab <- pol_change_table(data, tab_title, tab_subtitle, p1name, p2name)
gtsave(tab, "sdsalt_allstates_table.png", path = here::here("results"))
...
for(st in nyus_sort){
  print(st)
  tab <- get_state_tab(st, policy1, policy2, p1name, p2name, dollars)
  gtsave(tab, paste0("sdsalt_byagi_table_", st, ".png"), path = here::here("results"))
  # print(tab)
}
